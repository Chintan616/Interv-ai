        ...
        <div className="text-[14px] prose prose-slate dark:prose-invert max-w-none">
            <ReactMarkdown 
                ...
                components={{
                    ...
                    h5({children}){
                        return <h5 className='text-sm font-bold mt-3 mb-2'>{children}</h5>
                    },
                    h6({children}){
                        return <h6 className='text-xs font-bold mt-2 mb-2'>{children}</h6>
                    },
                    a({children,href}){
...
function CodeBlock({code,language}){
    ...
    return <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
        ...
        <SyntaxHighlighter
            language={language}
            style={oneLight}
            customStyle={{fontSize:12.5,margin : '1rem',background:'transparent'}}
            >
                {code}
            </SyntaxHighlighter>
