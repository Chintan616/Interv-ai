...
const SummaryCard = ({colors,role,topicsToFocus,experience,questions,description,lastUpdated,onSelect,onDelete
  ...
  return (
    <div
        className='bg-white border-gray-300/40 rounded-xl p-2 overflow-hidden cursor-pointer hover:shadow-xl shadow-gray-100 relative group'
        onClick={onSelect}>
                ...
                <div className="grow">
                    <div className="flex justify-between items-start">
                        <div className="flex-1 min-w-0">
                            <h2 className="text-[15px] md:text-[17px] font-medium truncate">{role}</h2>
                            <p className="text-[11px] md:text-xs text-medium text-gray-900 line-clamp-1">
                                {topicsToFocus}
                            </p>
                        </div>
                    </div>
        ...
        <div className="px-3 pb-3">
            <div className="flex flex-wrap items-center gap-2 mt-4">
                <div className="text-[9px] md:text-[10px] font-medium text-black px-2 md:px-3 py-1 border-[0.5px] border-gray-900 rounded-full whitespace-nowrap">
            ...
            <p className="text-[11px] md:text-[12px] text-gray-500 font-medium line-clamp-2 mt-3">
                {description}
            </p>            
